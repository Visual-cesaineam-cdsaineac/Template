...
function preload() {
  ...
  uvShader = readShader('/Template/sketches/shaders/uv_alpha.frag', { matrices: Tree.pmvMatrix, varyings: Tree.texcoords2 });
}
...
function draw() {
  ...
  //triangle(0, 0, width, 0, width, height, 0, height);
